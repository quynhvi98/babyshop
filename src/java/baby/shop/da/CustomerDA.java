...
public class CustomerDA {
    public List<Customer> ListCustomer() throws ClassNotFoundException {
    ...
    public boolean checkOut(String name,String phone,String address, float total) throws ClassNotFoundException {
        int result = 0;
        try {
